...
public record ZitaDelApplication
{
    ...
    /// </exception>
    public static async Task<ZitaDelApplication> LoadFromJsonFileAsync(string pathToJson)
    {
    ...
    public static ZitaDelApplication LoadFromJsonFile(string pathToJson) => LoadFromJsonFileAsync(pathToJson).Result;
    ...
    /// or when there is remaining data in the Stream.
    /// </exception>
    public static async Task<ZitaDelApplication> LoadFromJsonStreamAsync(Stream stream) =>
        await JsonSerializer.DeserializeAsync<ZitaDelApplication>(
            stream,
    ...
    public static ZitaDelApplication LoadFromJsonStream(Stream stream) => LoadFromJsonStreamAsync(stream).Result;
    ...
    /// or when there is remaining data in the Stream.
    /// </exception>
    public static async Task<ZitaDelApplication> LoadFromJsonStringAsync(string json)
    {
    ...
    public static ZitaDelApplication LoadFromJsonString(string json) => LoadFromJsonStringAsync(json).Result;
